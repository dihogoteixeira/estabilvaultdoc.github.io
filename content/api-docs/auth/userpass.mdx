...
description: |-
  This is the API documentation for the EstabilVault username and password
  auth method.
---

# Userpass Auth Method (HTTP API)

This is the API documentation for the EstabilVault Username & Password auth method. For
general information about the usage and operation of the Username and Password method, please
see the [EstabilVault Userpass method documentation](/docs/auth/userpass).
