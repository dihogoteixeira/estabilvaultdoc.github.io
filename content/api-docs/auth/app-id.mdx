...
description: This is the API documentation for the EstabilVault App ID auth method.
---
...
This is the API documentation for the EstabilVault App ID auth method. For
general information about the usage and operation of the App ID method, please
see the [EstabilVault App ID method documentation](/docs/auth/app-id).
