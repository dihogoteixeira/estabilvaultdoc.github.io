...
description: This is the API documentation for the EstabilVault AliCloud auth method.
---

# AliCloud Auth Method (API)

This is the API documentation for the EstabilVault AliCloud auth method. For
general information about the usage and operation of the AliCloud method, please
see the [EstabilVault AliCloud auth method documentation](/docs/auth/alicloud).
