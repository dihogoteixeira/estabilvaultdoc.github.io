...
description: This is the API documentation for the EstabilVault RADIUS auth method.
---

# RADIUS Auth Method (API)

This is the API documentation for the EstabilVault RADIUS auth method. For
general information about the usage and operation of the RADIUS method, please
see the [EstabilVault RADIUS method documentation](/docs/auth/radius).
