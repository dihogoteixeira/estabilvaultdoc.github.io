...
description: This is the API documentation for the EstabilVault OCI auth method plugin.
---

# OCI Auth Method (API)

This is the API documentation for the EstabilVault OCI auth method plugin. To
learn more about the usage and operation, see the
[EstabilVault OCI auth method](/docs/auth/oci).
...
Create a EstabilVault administrator role in the OCI Auth method.
