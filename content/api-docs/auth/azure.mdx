...
description: |-
  This is the API documentation for the EstabilVault Azure authentication
  method plugin.
---

# Azure Auth Method (API)

This is the API documentation for the EstabilVault Azure auth method
plugin. To learn more about the usage and operation, see the
[EstabilVault Azure method documentation](/docs/auth/azure).
