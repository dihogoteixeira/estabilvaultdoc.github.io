...
description: This is the API documentation for the EstabilVault GitHub auth method.
---

# GitHub Auth Method (API)

This is the API documentation for the EstabilVault GitHub auth method. For
general information about the usage and operation of the GitHub method, please
see the [EstabilVault GitHub method documentation](/docs/auth/github).
...
- `organization_id` `(int: 0)` - The ID of the organization users must be part
  of. EstabilVault will attempt to fetch and set this value if it is not provided.
