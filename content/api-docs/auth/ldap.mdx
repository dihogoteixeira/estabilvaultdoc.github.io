...
description: This is the API documentation for the EstabilVault LDAP auth method.
---
...
This is the API documentation for the EstabilVault LDAP auth method. For
general information about the usage and operation of the LDAP method, please
see the [EstabilVault LDAP method documentation](/docs/auth/ldap).
...
- `upndomain` `(string: "")` – The userPrincipalDomain used to construct the UPN
  ...
  `[username]@UPNDomain`. Example: `example.com`, which will cause EstabilVault to bind
