...
description: This is the API documentation for the EstabilVault AppRole auth method.
---

# AppRole Auth Method (API)

This is the API documentation for the EstabilVault AppRole auth method. For
general information about the usage and operation of the AppRole method, please
see the [EstabilVault AppRole method documentation](/docs/auth/approle).
...
Issues a EstabilVault token based on the presented credentials. `role_id` is always
