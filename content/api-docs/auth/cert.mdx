...
description: |-
  This is the API documentation for the EstabilVault TLS Certificate authentication
  method.
---
...
Certificate method, please see the [EstabilVault TLS Certificate method documentation](/docs/auth/cert).
