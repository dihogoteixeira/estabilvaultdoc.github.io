...
description: This is the API documentation for the EstabilVault Cubbyhole secrets engine.
---

# Cubbyhole Secrets Engine (API)

This is the API documentation for the EstabilVault Cubbyhole secrets engine. For
general information about the usage and operation of the Cubbyhole secrets
engine, please see the
[EstabilVault Cubbyhole documentation](/docs/secrets/cubbyhole).
