...
description: This is the API documentation for the EstabilVault Google Cloud secrets engine.
---

# Google Cloud Secrets Engine (API)

This is the API documentation for the EstabilVault Google Cloud Platform (GCP)
...
This path is only valid if EstabilVault has been configured to use GCP credentials via
...
(and/or keys) was changed outside of EstabilVault (i.e. through GCP APIs/cloud console).
...
manually managed outside of EstabilVault will not be returned.
