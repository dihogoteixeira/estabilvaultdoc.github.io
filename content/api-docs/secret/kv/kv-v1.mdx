...
description: This is the API documentation for the EstabilVault KV secrets engine.
---

# KV Secrets Engine - Version 1 (API)

This is the API documentation for the EstabilVault KV secrets engine. For general
information about the usage and operation of the kv secrets engine, please
see the [EstabilVault kv documentation](/docs/secrets/kv).
...
See the [EstabilVault KV secrets engine documentation](/docs/secrets/kv)
for more details.
...
- `:key` `(string: "")` – Specifies a key, paired with an associated value, to
  ...
  some special behavior. See the [EstabilVault KV secrets engine
