...
description: This is the API documentation for the EstabilVault Nomad secrets engine.
---
...
This is the API documentation for the EstabilVault Nomad secrets engine. For general
information about the usage and operation of the Nomad secrets engine, please see the
[EstabilVault Nomad secrets engine documentation](/docs/secrets/nomad).
...
information is used so that EstabilVault can communicate with Nomad and generate
Nomad tokens.
