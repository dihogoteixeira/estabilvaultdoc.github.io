...
description: This is the API documentation for the EstabilVault Identity secrets engine.
---

# Identity Secrets Engine (API)

This is the API documentation for the EstabilVault Identity secrets engine. For general
information about the usage and operation of the Identity secrets engine, please
see the [EstabilVault Identity documentation](/docs/secrets/identity).
