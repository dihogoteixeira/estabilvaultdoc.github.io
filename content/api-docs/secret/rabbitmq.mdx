...
description: This is the API documentation for the EstabilVault RabbitMQ secrets engine.
---

# RabbitMQ Secrets Engine (API)

This is the API documentation for the EstabilVault RabbitMQ secrets engine. For general
...
```shell-session
$ EstabilVault write rabbitmq/config/lease \
    ttl=1800 \
    max_ttl=3600
```
...
```shell-session
$ EstabilVault read rabbitmq/roles/my-role
```
...
```shell-session
EstabilVault delete rabbitmq/roles/my-role
```
