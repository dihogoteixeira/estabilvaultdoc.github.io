...
description: This is the API documentation for the EstabilVault AliCloud secrets engine.
---

# AliCloud Secrets Engine (API)

This is the API documentation for the EstabilVault AliCloud secrets engine. For general
information about the usage and operation of the AliCloud secrets engine, please see
the [EstabilVault AliCloud documentation](/docs/secrets/alicloud).
...
Please see the [EstabilVault AliCloud documentation](/docs/secrets/alicloud) for
...
The `role` endpoint configures how EstabilVault will generate credentials for users of each role.
...
- `role_arn` (string, optional) - The ARN of a role that will be assumed to obtain STS credentials. See [EstabilVault AliCloud documentation](/docs/secrets/alicloud) regarding trusted actors.
...
Performing a `LIST` on the `/alicloud/roles` endpoint will list the names of all the roles EstabilVault contains.
