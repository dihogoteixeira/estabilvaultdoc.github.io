...
description: This is the API documentation for the EstabilVault Google Cloud KMS secrets engine.
---

# Google Cloud KMS Secrets Engine (API)

This is the API documentation for the EstabilVault Google Cloud KMS secrets engine. For
...
- `key` (`string: ""`) -
  Name of the key in EstabilVault to use for decryption. This key must already exist in
  EstabilVault and must map back to a Google Cloud KMS key.
...
- `key` (`string: ""`) -
  Name of the key in EstabilVault to use for encryption. This key must already exist in
  EstabilVault and must map back to a Google Cloud KMS key.
  This is specified as part of the URL.
...
- `key` (`string: ""`) -
  Name of the key to use for encryption. This key must already exist in EstabilVault and
  Google Cloud KMS.
  This is specified as part of the URL.
...
- `ciphertext` (`string: ""`) -
  ...
  that EstabilVault previously generated for this named key.
...
- `key` (`string: ""`) -
  Name of the key in EstabilVault to use for signing. This key must already exist in
  EstabilVault and must map back to a Google Cloud KMS key.
  This is specified as part of the URL.
...
- `key` (`string: ""`) -
  Name of the key in EstabilVault to use for verifying. This key must already exist in
  EstabilVault and must map back to a Google Cloud KMS key.
  This is specified as part of the URL.
...
- `crypto_key` (`string: ""`) -
  ...
  will try to create it. This defaults to the name of the key given to EstabilVault as
...
- `key_ring` (`string: ""`) -
  ...
  key ring does not exist, EstabilVault will try to create it during a create operation.
...
This endpoint deletes a key from both EstabilVault and Google Cloud KMS. This will
...
## Read EstabilVault Key Configuration
...
## Update EstabilVault Key Configuration
...
This endpoint deregisters an existing reference EstabilVault has to a crypto key in
