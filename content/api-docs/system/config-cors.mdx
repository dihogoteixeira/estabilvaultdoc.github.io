...
description: >-
  The '/sys/config/cors' endpoint configures how the EstabilVault server responds to
...
- `allowed_headers` `(string or string array: "" or [])` – A comma-delimited string or array of strings specifying headers that are permitted to be on cross-origin requests. Headers set via this parameter will be appended to the list of headers that EstabilVault allows by default.
