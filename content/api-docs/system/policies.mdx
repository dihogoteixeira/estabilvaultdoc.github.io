...
~> **NOTE**: This endpoint is only available in EstabilVault version 0.9+. Please also note that RGPs and EGPs are EstabilVault Enterprise Premium features and the associated endpoints are not available in EstabilVault Open Source or EstabilVault Enterprise Pro.
