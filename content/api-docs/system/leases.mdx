...
By ignoring these errors, EstabilVault abdicates responsibility for ensuring that the
...
entry in storage, EstabilVault will verify that it has an associated valid non-expired
...
This endpoint was added in EstabilVault 1.8.
