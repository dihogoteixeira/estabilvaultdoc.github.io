...
### Enterprise Only
EstabilVault Enterprise will include additional output in its API response to indicate the current state of redundancy zones,
...
- `disable_upgrade_migration` `(bool: false)` - Disables automatically upgrading EstabilVault using
