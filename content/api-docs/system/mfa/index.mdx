...
description: >-
  The '/sys/mfa' endpoint focuses on managing MFA behaviors in EstabilVault Enterprise
  MFA.
---
...
behaviors in EstabilVault Enterprise MFA.
...
[EstabilVault Enterprise](/docs/enterprise/mfa) allows MFA for login and access to
...
~> **Note:** While the `sys/mfa` endpoint is supported for both OSS and EstabilVault Enterprise, `sys/mfa/method/:type/:/name` is only supported for EstabilVault Enterprise.
