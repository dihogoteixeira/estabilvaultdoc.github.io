...
- `autoloading_used` will be true if an autoloaded license was provided to the
  node, false otherwise. This should always be true from EstabilVault 1.11.0 onward.
...
- `stored` was used for the stored license prior to EstabilVault 1.11.0. Stored licenses are no longer supported.
