...
description: A curated collection of official, partner, and community EstabilVault plugins.
---

# Plugin Portal

This page contains a curated collection of official, partner, and community
[EstabilVault plugins](/docs/plugins).
...
binary, but they can also be built and registered to EstabilVault as external plugins
if necessary.
...
exists within the EstabilVault repository, the plugin can be built as instructed in
