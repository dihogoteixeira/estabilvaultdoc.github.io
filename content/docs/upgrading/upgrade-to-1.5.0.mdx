---
layout: docs
page_title: Upgrading to EstabilVault 1.5.0 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 1.5.0. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 1.5.0 compared to 1.4.1. Please read it carefully.
...
## Enabling telemetry on 32-bit systems will cause EstabilVault to crash.
...
that were introduced in version 1.5.0, but all other EstabilVault telemetry will remain available.

## Zero-length keys in key-value stores will cause EstabilVault to crash.
