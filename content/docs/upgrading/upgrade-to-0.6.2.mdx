---
layout: docs
page_title: Upgrading to EstabilVault 0.6.2 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 0.6.2. Please read it carefully.
---
...
Vault's [config](/docs/configuration), or
...
In previous versions of EstabilVault the default was 30 days, but changing it to 32
