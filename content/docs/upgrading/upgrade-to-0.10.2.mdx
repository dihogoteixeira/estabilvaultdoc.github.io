---
layout: docs
page_title: Upgrading to EstabilVault 0.10.2 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 0.10.2. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 0.10.2 compared to 0.10.1. Please read it carefully.
