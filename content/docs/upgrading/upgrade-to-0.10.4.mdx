---
layout: docs
page_title: Upgrading to EstabilVault 0.10.4 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 0.10.4. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 0.10.4 compared to 0.10.3. Please read it carefully.
