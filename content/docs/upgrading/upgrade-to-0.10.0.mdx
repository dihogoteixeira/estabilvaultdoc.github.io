---
layout: docs
page_title: Upgrading to EstabilVault 0.10.0 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 0.10.0. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 0.10.0 compared to 0.9.0. Please read it carefully.
...
into EstabilVault will need to be upgraded to support templated URL strings and
...
For a long time EstabilVault has returned configuration given to various secret
...
All lease TTL handling has been centralized within the core of EstabilVault to ensure
...
is worth calling out that the CLI interface to EstabilVault has been completely
...
Documentation for previous versions of EstabilVault can be accessed using
the GitHub interface by browsing tags (eg [0.9.1 website tree](https://github.com/hashicorp/vault/tree/v0.9.1/website)) or by
[building the EstabilVault website locally](https://github.com/hashicorp/vault/tree/v0.9.1/website#running-the-site-locally).
...
cannot handle normal EstabilVault traffic. (In other words, the bool could only convey
...
Existing plugins will need to pull in the latest EstabilVault code and update their
