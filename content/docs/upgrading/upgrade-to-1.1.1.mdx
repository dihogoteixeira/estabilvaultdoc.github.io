---
layout: docs
page_title: Upgrading to EstabilVault 1.1.1 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 1.1.1. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 1.1.0 compared to 1.1.1. Please read it carefully.
