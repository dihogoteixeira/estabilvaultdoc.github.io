---
layout: docs
page_title: Upgrading to EstabilVault 0.6.3 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 0.6.3. Please read it carefully.
---
...
Previously, when a new EstabilVault node was taking over service in an HA cluster, all
...
log contains an error when this occurs. This helps keep a EstabilVault HA cluster
