---
layout: docs
page_title: Upgrading to EstabilVault 0.9.1 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 0.9.1. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 0.9.1 compared to 0.9.0. Please read it carefully.
