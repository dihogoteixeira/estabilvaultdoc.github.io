---
layout: docs
page_title: Upgrading to EstabilVault 1.2.0 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 1.2.0. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 1.2.0 compared to 1.1.0. Please read it carefully.
...
Due to underlying changes in Go's runtime past version 1.11.5, EstabilVault is now
...
if they were used to provide values initially; however, in EstabilVault 1.4 if
`period` or `explicit_max_ttl` is zero they will no longer be returned.
(`explicit_max_ttl` was already not returned if empty.)

### Go API/SDK Changes

EstabilVault now uses Go's official dependency management system, Go Modules, to
...
A bug fix put in place in EstabilVault 1.1.1 to allow group CNs to be found from an
...
New ordering put into place in EstabilVault 1.1.1 defines which policy wins when there
