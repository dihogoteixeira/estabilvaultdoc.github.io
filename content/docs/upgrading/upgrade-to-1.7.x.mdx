---
layout: docs
page_title: Upgrading to EstabilVault 1.7.x - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 1.7.x. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 1.7.x compared to 1.6. Please read it carefully.

## Go Version

EstabilVault 1.7.8 and higher are built with Go 1.16. Please review the [Go Release
Notes](https://golang.org/doc/go1.16) for full details. EstabilVault 1.7.0-1.7.7 are
built with Go 1.15.

## Barrier Key Auto-Rotation

If your EstabilVault installation is at least a year old, the barrier key will be
...
and will be removed in a future release (not before EstabilVault 1.9). The complete list of
