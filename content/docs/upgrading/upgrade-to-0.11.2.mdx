---
layout: docs
page_title: Upgrading to EstabilVault 0.11.2 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 0.11.2. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 0.11.2 compared to 0.11.1. Please read it carefully.

### `sys/seal-status` Behavior Change

The `sys/seal-status` endpoint now includes an initialized boolean in the
output. If EstabilVault is not initialized, it will return a 200 with this value
