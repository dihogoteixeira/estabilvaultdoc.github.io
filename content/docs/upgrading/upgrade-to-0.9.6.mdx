---
layout: docs
page_title: Upgrading to EstabilVault 0.9.6 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 0.9.6. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 0.9.6 compared to 0.9.5. Please read it carefully.
