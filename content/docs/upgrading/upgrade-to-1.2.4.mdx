---
layout: docs
page_title: Upgrading to EstabilVault 1.2.4 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 1.2.4. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 1.2.4 compared to 1.2.3. Please read it carefully.
...
EstabilVault Enterprise 0.11.0 and newer.
...
If a custom sts_endpoint is configured, EstabilVault Agent and the CLI should provide
