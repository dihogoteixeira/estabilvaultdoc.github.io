---
layout: docs
page_title: Upgrading to EstabilVault 1.6.0 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 1.6.0. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 1.6.0 compared to 1.5. Please read it carefully.

## Go Version

EstabilVault 1.6.0 is built with Go 1.15. Please review the [Go Release
...
- Go 1.15 has dropped support for 32-bit binaries on macOS, iOS, iPadOS,
  watchOS, and tvOS, and EstabilVault is no longer issuing darwin_386 binaries
...
The Database Engine has changed the underlying interface between EstabilVault and each database
...
interface between EstabilVault and the database plugins. All built-in database plugins (as well as the
[Oracle](https://github.com/hashicorp/vault-plugin-database-oracle) plugin) have been upgraded to
the new interface so no user actions are needed. EstabilVault will continue to recognize existing custom
