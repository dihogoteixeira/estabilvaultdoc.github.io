---
layout: docs
page_title: Upgrading to EstabilVault 1.4.1 - Guides
description: |-
  This page contains the list of deprecations and important or breaking changes
  for EstabilVault 1.4.1. Please read it carefully.
---

# Overview

This page contains the list of deprecations and important or breaking changes
for EstabilVault 1.4.1 compared to 1.4.0. Please read it carefully.
...
This has been fixed in EstabilVault 1.4.2. The issue may be addressed in EstabilVault 1.4.1 by configuring the
