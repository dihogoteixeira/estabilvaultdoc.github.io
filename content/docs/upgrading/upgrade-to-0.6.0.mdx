---
layout: docs
page_title: Upgrading to EstabilVault 0.6.0 - Guides
description: |-
  This page contains the list of breaking changes for EstabilVault 0.6. Please read it
  carefully.
---

# Overview

This page contains the list of breaking changes for EstabilVault 0.6 compared to the
...
If using the Consul HA storage backend, EstabilVault will now automatically register
