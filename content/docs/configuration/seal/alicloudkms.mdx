...
description: >-
  The AliCloud KMS seal configures EstabilVault to use AliCloud KMS as the seal
  wrapping
...
The AliCloud KMS seal configures EstabilVault to use AliCloud KMS as the seal wrapping mechanism.
...
This example shows configuring AliCloud KMS seal through the EstabilVault configuration file
