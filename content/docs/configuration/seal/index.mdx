...
As of EstabilVault 0.9.0, the seal can also be used for [seal wrapping][sealwrap] to
add an extra layer of protection and satisfy compliance and regulatory requirements.
This feature is only available in EstabilVault Enterprise.
...
Seal configuration can be done through the EstabilVault configuration file using the
`seal` stanza:
