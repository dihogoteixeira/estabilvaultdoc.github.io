...
At the moment managed keys are only available as a feature set within EstabilVault Enterprise HSM edition.
...
These parameters apply to the `kms_library` stanza of type `pkcs11` in the EstabilVault configuration file:
