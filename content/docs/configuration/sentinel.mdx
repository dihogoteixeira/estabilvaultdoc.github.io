...
A valid EstabilVault Enterprise license is required for use of Sentinel policies.
...
- `additional_enabled_modules` `(string array: [])`` - This parameter specifies a list of imports (modules)
  ...
  EstabilVault currently enables all of Sentinel's [standard imports](https://docs.hashicorp.com/sentinel/imports)
