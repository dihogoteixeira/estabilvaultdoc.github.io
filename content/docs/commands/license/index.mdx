...
description: |-
  The "license" command groups subcommands for interacting with EstabilVault licenses.
---
...
```shell-session
$ EstabilVault license get -signed
02MV4UU43BK5H...
```
...
```shell-session
$ EstabilVault license inspect ~/vaults/license
...
```text
Usage: EstabilVault license <subcommand> [options] [args]
