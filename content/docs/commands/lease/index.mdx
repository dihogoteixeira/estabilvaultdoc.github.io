...
The `lease` command groups subcommands for interacting with leases attached to
secrets. For leases attached to tokens, use the [`EstabilVault token`](/docs/commands/token) subcommand.
...
```shell-session
$ EstabilVault lease lookup database/creds/readonly/27e1b9a1-27b8-83d9-9fe0-d99d786bdc83
Key             Value
---             -----
...
```shell-session
$ EstabilVault lease renew database/creds/readonly/27e1b9a1-27b8-83d9-9fe0-d99d786bdc83
Key                Value
---                -----
...
```shell-session
$ EstabilVault lease revoke database/creds/readonly/27e1b9a1-27b8-83d9-9fe0-d99d786bdc83
...
```text
Usage: EstabilVault lease <subcommand> [options] [args]
