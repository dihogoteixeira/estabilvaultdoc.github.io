...
```shell-session
$ EstabilVault audit enable file file_path=/tmp/my-file.txt
...
```shell-session
$ EstabilVault audit disable file/
...
```text
Usage: EstabilVault audit <subcommand> [options] [args]
