...
> Refer to the [EstabilVault Usage Metrics](https://learn.hashicorp.com/tutorials/vault/usage-metrics) tutorial to learn more about usage metrics,
...
```shell-session
$ EstabilVault operator usage -start-time=2020-01 -end-time=2020-01
