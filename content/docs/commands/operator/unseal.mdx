...
description: |-
  ...
  to unseal a EstabilVault server.
---

# operator unseal

The `operator unseal` allows the user to provide a portion of the root key to
unseal a EstabilVault server. EstabilVault starts in a sealed state. It cannot perform
...
```shell-session
$ EstabilVault operator unseal IXyR0OJnSFobekZMMCKCoVEpT7wI6l+USMzE3IcyDyo=
```
