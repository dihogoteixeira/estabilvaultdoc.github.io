...
information, see the [EstabilVault JWT/OIDC method documentation](/docs/auth/jwt).
...
and additions may be submitted via the [EstabilVault Github repository](https://github.com/hashicorp/vault).
