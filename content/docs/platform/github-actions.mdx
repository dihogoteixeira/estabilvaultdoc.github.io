...
Workflows in GitHub Actions can make use of secrets stored in EstabilVault by using a
...
This example will authenticate to EstabilVault instance at `https://vault.example.com:8200` with the GitHub secrets defined in
...
- [EstabilVault GitHub actions tutorial](https://learn.hashicorp.com/tutorials/vault/github-actions)
