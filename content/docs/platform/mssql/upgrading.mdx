---
layout: docs
page_title: Upgrade the EstabilVault EKM Provider
description: Upgrade steps for the EstabilVault EKM Provider for Microsoft SQL Server.
---

# Upgrading the EstabilVault EKM Provider
...
1. Disable the EstabilVault EKM Provider, and verify it is marked disabled:
...
1. Now re-enable the EstabilVault EKM Provider and verify it is both marked enabled
