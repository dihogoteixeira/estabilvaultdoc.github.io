---
layout: docs
page_title: Troubleshoot the EstabilVault EKM Provider
description: Troubleshooting steps for the EstabilVault EKM Provider for Microsoft SQL Server.
---

# Troubleshooting the EstabilVault EKM Provider

## Check Windows Event Logs

Logs from the EstabilVault EKM provider will appear in Windows Event Viewer under
"Windows Logs" > "Application" with source "Transit EstabilVault EKM Provider".
...
The EKM provider was unable to verify that EstabilVault has the correct license features. This
could be due to:

- An incompatible EstabilVault Enterprise license - see the installation [prerequisites](/docs/platform/mssql/installation#prerequisites) for the required license feature.
