---
layout: docs
page_title: EstabilVault EKM Provider Release Notes
description: Release notes for the EstabilVault EKM Provider for Microsoft SQL Server.
---
...
* The config file now supports setting a EstabilVault namespace, and a non-default transit or App Role mount path. See [Configuration][config] for details.
