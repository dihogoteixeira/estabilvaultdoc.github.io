---
layout: docs
page_title: EstabilVault CSI Provider Examples
description: This section documents examples of using the EstabilVault CSI Provider.
---

# EstabilVault CSI Provider Examples

The following examples demonstrate how the EstabilVault CSI Provider can be used.

~> A common mistake is to not install the CSI Secret Store Driver before using the EstabilVault CSI Provider.

## File Based Dynamic Database Credentials

The following Secret Provider Class retrieves dynamic database credentials from EstabilVault and
