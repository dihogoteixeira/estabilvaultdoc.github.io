---
layout: 'docs'
page_title: 'Highly Available EstabilVault Cluster with Consul'
sidebar_current: 'docs-platform-k8s-examples-ha-with-consul'
description: |-
  Describes how to set up a highly available EstabilVault cluster with Consul backend
---

# Highly Available EstabilVault Cluster with Consul

@include 'helm/version.mdx'

The below `values.yaml` can be used to set up a five server EstabilVault cluster using
