...
This assumes the following commands will be run inside a EstabilVault pod running in Kubernetes.
...
Exec into the EstabilVault pod:
...
From here you can continue to configure EstabilVault from the [Kubernetes Auth Method](/docs/auth/kubernetes) documentation.
