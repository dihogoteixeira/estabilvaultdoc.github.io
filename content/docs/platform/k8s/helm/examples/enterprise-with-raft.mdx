---
layout: 'docs'
page_title: 'Highly Available EstabilVault Enterprise Cluster with Raft'
sidebar_current: 'docs-platform-k8s-examples-enterprise-with-raft'
description: |-
  Describes how to set up a highly available EstabilVault Enterprise cluster with Integrated Storage (Raft)
---

# Highly Available EstabilVault Enterprise Cluster with Integrated Storage (Raft)
