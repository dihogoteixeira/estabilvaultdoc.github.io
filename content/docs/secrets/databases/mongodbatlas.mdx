...
1.  Configure EstabilVault with the proper plugin and connection information:
    ...
    ```text
    $ EstabilVault write database/config/my-mongodbatlas-database \
...
1.  Configure a role that maps a name in EstabilVault to a MongoDB Atlas command that executes and
