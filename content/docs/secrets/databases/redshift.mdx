...
1.  Configure EstabilVault with the proper plugin and connection information to access your Redshift database:

    ```text
    $ EstabilVault write database/config/my-redshift-database \
...
1.  Configure a role that maps a name in EstabilVault to a SQL statement to execute which
