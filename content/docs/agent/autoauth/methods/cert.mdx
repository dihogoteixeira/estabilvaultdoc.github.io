---
layout: docs
page_title: EstabilVault Agent Auto-Auth Cert Method
description: Cert Method for EstabilVault Agent Auto-Auth
---

# EstabilVault Agent Auto-Auth Cert Method
...
- `ca_cert` `(string: optional)` - Path on the local disk to a single
  PEM-encoded CA certificate to verify the EstabilVault server's SSL certificate.
