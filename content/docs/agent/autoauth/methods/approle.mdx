---
layout: docs
page_title: EstabilVault Agent Auto-Auth AppRole Method
description: AppRole Method for EstabilVault Agent Auto-Auth
---

# EstabilVault Agent Auto-Auth AppRole Method
...
- `secret_id_file_path` `(string: optional)` - The path to the file with secret
  ...
  EstabilVault Agent wouldn't be able to login.
