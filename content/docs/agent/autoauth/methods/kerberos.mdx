---
layout: 'docs'
page_title: 'EstabilVault Agent Auto-Auth Kerberos Method'
sidebar_current: 'docs-agent-autoauth-methods-kerberos'
description: |-
  Kerberos Method for EstabilVault Agent Auto-Auth
---

# EstabilVault Agent Auto-Auth Kerberos Method

The `kerberos` agent provides an automated mechanism to retrieve
a EstabilVault token for Kerberos entities. It reads in configuration and
