---
layout: docs
page_title: EstabilVault Agent Auto-Auth File Sink
description: File sink for EstabilVault Agent Auto-Auth
---

# EstabilVault Agent Auto-Auth File Sink
...
- `mode` `(int: optional)` - A string containing an octal number representing the bit pattern for the file mode, similar to chmod. Set to `0000` to prevent EstabilVault from modifying the file mode. Note: This configuration option is only available in EstabilVault 1.3.0 and above.
